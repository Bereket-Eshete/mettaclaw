...
class TelegramChannel(BaseChannel):
    def __init__(self, bot_token, chat_id="", poll_timeout=20):
        ...
        # Telegram auth needs two fields: user_id + chat_id
        self._authenticated_chat_id = None

    # ------------------------------------------------------------------
    # Auth — Telegram needs user_id + chat_id pair
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # Lifecycle override — initialize offset before polling
    # ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Module-level API (called from channels.metta via py-call)
# ------------------------------------------------------------------
